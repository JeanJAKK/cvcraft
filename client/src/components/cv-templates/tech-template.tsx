  ...
  return (
    ...
    >
      ...
      {personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-lg font-bold text-cyan-600 mb-3 font-mono">
            // About
          </h2>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {experience.map((exp) => (
              <div
                key={exp.id}
                className="bg-gray-50 p-3 rounded border-l-2 border-cyan-500"
              >
                <div className="flex justify-between items-start mb-1">
                  <div>
                    <h3 className="font-bold font-mono text-cyan-700">
          ...
          <div className="flex flex-wrap gap-2">
            {skills
              ...
              .map((skill, index) => (
                <span
                  key={index}
                  className="bg-cyan-100 text-cyan-700 px-3 py-1 rounded text-sm font-mono"
                >
                  {skill}
                </span>
              ))}
