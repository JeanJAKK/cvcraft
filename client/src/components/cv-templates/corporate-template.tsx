  ...
  return (
    <div className="bg-white text-gray-900 p-12 min-h-[297mm]" style={{ width: "210mm" }}>
      ...
      {personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-sm font-bold text-blue-900 mb-3 uppercase tracking-wide">Professional Overview</h2>
      ...
      {experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-sm font-bold text-blue-900 mb-4 uppercase tracking-wide border-b-2 border-blue-900 pb-2">Professional Experience</h2>
          <div className="space-y-6">
            {experience.map((exp) => (
              <div key={exp.id}>
                ...
                <p className="text-sm text-blue-700 font-semibold mb-1">{exp.company || "Company"}</p>
                {exp.description && (
      ...
      {skills.length > 0 && (
        <div>
          <h2 className="text-sm font-bold text-blue-900 mb-3 uppercase tracking-wide border-b-2 border-blue-900 pb-2">Core Competencies</h2>
